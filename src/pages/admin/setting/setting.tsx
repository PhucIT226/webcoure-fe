...
const SettingsPage = () => {
  ...
  const menuItems = [
    { id: "system", label: t("system"), color: "from-green-400 to-green-500", component: <SystemSettings /> },
    { id: "profile", label: t("profile"), color: "from-green-400 to-green-500", component: <ProfileSettings /> },
  ];
  ...
  return (
    <div className="p-6 bg-base-100 min-h-screen lg:flex gap-6">
      ...
      <div className="bg-gradient-to-r from-amber-700 via-amber-600 to-amber-700 text-white 
        ...
        <h2 className="text-2xl text-center font-bold mb-6 text-gray-800">{t("settings")}</h2>
